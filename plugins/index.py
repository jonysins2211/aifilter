...
async def send_for_index(bot, message):
    ...
    if k.empty:
        return await message.reply('This may be a group and I am not an admin there.')
    ...
    if type(chat_id) is int:
        try:
            ...
            return await message.reply('Make sure I am an admin in the chat and can create invite links.')
    else:
        link = f"@{message.forward_from_chat.username}"

    buttons = [
        [InlineKeyboardButton('Request Index', callback_data=f'index#accept#{chat_id}#{last_msg_id}#{message.from_user.id}')],
    ...
    await message.reply('🎉\n\n❤️ Thank You For the Contribution. Wait for our moderators to verify the files.\n\n🎁')
